...
export const restaurantSettings = pgTable('restaurant_settings', { restaurantId: text('restaurant_id').primaryKey(), theme: text('theme').default('terracotta').notNull(), accentColor: text('accent_color').default('#ea580c').notNull(), logoUrl: text('logo_url'), receiptFooter: text('receipt_footer'), updatedAt: timestamp('updated_at').defaultNow().notNull() })
